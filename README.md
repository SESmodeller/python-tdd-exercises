...
[![Build Status](https://travis-ci.org/SESmodeller/python-tdd-exercises.svg?branch=master)](https://travis-ci.org/SESmodeller/python-tdd-exercises/builds)
[![Coverage Status](https://coveralls.io/repos/SESmodeller/python-tdd-exercises/badge.png?branch=master)](https://coveralls.io/r/SESmodeller/python-tdd-exercises?branch=master)

After you fork, edit this `README.md` and rename "SESmodeller" to your GitHub username
...
- Increase the test coverage to 100% by making [all lines](https://coveralls.io/r/SESmodeller/python-tdd-exercises?branch=master) green.
